...
export default function ClientsPage() {
  ...
  return (
    <div style={{ paddingTop: "80px" }}>
      ...
      {/* Industries */}
      <section className="py-12 md:py-24" style={{ background: "#f4f6f9" }}>
        <div className="max-w-7xl mx-auto px-6">
          <Reveal>
            <div className="text-center mb-8 md:mb-14">
              <span className="inline-block bg-blue-50 text-blue-700 text-xs font-semibold tracking-widest uppercase px-3 py-1.5 rounded-full mb-4">Industry Sectors</span>
              <h2 className="text-4xl text-gray-900" style={{ fontFamily: "'DM Serif Display',serif" }}>
                We Secure <span style={{ color: "#1e40af" }}>Every Sector</span>
              </h2>
            </div>
          </Reveal>
          <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 md:gap-5 mb-16">
            {industries.map((item, i) => (
              <Reveal key={i} delay={i * 0.04}>
                <div className="relative rounded-2xl bg-white transition-all duration-300 group cursor-default p-5 md:p-7 flex flex-col items-center text-center"
                  ...
                  <h3 className="font-bold text-gray-900 mb-1 text-xs md:text-sm leading-snug uppercase tracking-wide">{item.title}</h3>
          ...
          <Reveal delay={0.1}>
            <div className="mb-12">
              <div className="text-center mb-8">
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900" style={{ fontFamily: "'DM Serif Display',serif" }}>We Serve All Client Types</h2>
