...
const inputClass = "w-full px-4 py-3 rounded-xl border-2 border-gray-200 text-sm text-gray-900 placeholder-gray-400 bg-white transition-all focus:outline-none focus:ring-2 focus:ring-blue-500/25 focus:border-blue-500";
    ...
    <div className="relative overflow-x-hidden" style={{ paddingTop: "96px", background: "linear-gradient(180deg, #050b17 0%, #0a1730 35%, #102a4d 65%, #0a1730 100%)" }}>
      ...
      {/* Hero */}
        <div className="relative">
          <div className="max-w-7xl mx-auto px-6 pt-10 pb-6 md:pt-14 md:pb-6 grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            <div>
              <div className="inline-flex items-center gap-2 mb-6 px-4 py-1.5 rounded-full backdrop-blur-sm" style={{ background: "rgba(220,38,38,0.12)", border: "1px solid rgba(248,113,113,0.35)", boxShadow: "0 4px 20px -4px rgba(220,38,38,0.3)" }}>
                <span className="w-1.5 h-1.5 rounded-full bg-red-500 animate-pulse" />
                <span className="text-xs font-bold tracking-wide uppercase text-red-300">Open Now &middot; Dispatch Available</span>
              </div>

              <div className="h-1 w-14 rounded-full mb-5" style={{ background: "linear-gradient(90deg,#38bdf8,#dc2626)" }} />
              ...
              <div className="grid grid-cols-3 gap-3">
                {[
                  { icon: Clock, value: "24/7", label: "Dispatch" },
                  { icon: Zap, value: "2 hrs", label: "Response" },
                  ...
                  <div key={i} className="p-4 rounded-2xl text-center bg-white border border-gray-100 shadow-sm hover:-translate-y-0.5 hover:shadow-md transition-all">
                    <s.icon className="w-5 h-5 mx-auto mb-1.5 text-blue-600" />
            ...
            <div className="relative pb-10 pr-3 sm:pr-4">
              <div className="absolute -top-2 -right-2 w-[94%] h-[94%] rounded-2xl" style={{ background: "linear-gradient(135deg,#0a1730 0%,#102a4d 55%,#050b17 100%)" }} />
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-5 gap-10 items-start">
            ...
            <Reveal className="lg:col-span-3">
              <div className="relative rounded-3xl p-10" style={{ background: "#ffffff", boxShadow: "0 25px 60px -15px rgba(0,0,0,0.5)", border: "1px solid #ffffff" }}>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    <label className="block text-xs font-bold mb-2 uppercase tracking-wider" style={{ color: "#1e3a8a" }}>Service Required</label>
                  ...
                  <div>
                    <label className="block text-xs font-bold mb-2 uppercase tracking-wider" style={{ color: "#1e3a8a" }}>Message</label>
            ...
            <Reveal delay={0.15} className="lg:col-span-2 space-y-5 lg:sticky lg:top-24">
              ...
              <div className="relative overflow-hidden rounded-3xl p-7 space-y-4" style={{ background: "linear-gradient(180deg, #050b17 0%, #0a1730 45%, #102a4d 100%)" }}>
                ...
                {[
                  ...
                  { icon: Mail, label: "Email Us", lines: [{ text: "info@enamos.co.ke", href: "mailto:info@enamos.co.ke" }] },
                  ...
                  { icon: Globe, label: "Website", lines: [{ text: "www.enamos.co.ke", href: "https://www.enamos.co.ke" }] },
                ].map((c, i) => (
