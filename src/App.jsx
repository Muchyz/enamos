        ...
        <Reveal delay={0.1}>
          <div className="grid lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="pt-4 border-t flex items-center justify-center" style={{ borderColor: "rgba(56,189,248,0.15)" }}>
                <button onClick={() => navigate("/director")}
                  className="group inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold text-white border transition-all hover:-translate-y-0.5 hover:shadow-lg hover:shadow-sky-500/25"
    ...
    <section className="pt-8 md:pt-10 pb-28 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-16 space-y-10">
          <Reveal delay={0.05}>
            <div className="relative pl-7 md:pl-9" style={{ borderLeft: "4px solid #dc2626" }}>
              <div className="flex items-center gap-2.5 mb-3">
                <Eye className="w-5 h-5" style={{ color: "#dc2626" }} />
                <span className="text-xs font-bold tracking-widest uppercase" style={{ color: "#dc2626" }}>Our Vision</span>
              </div>
              <p className="text-xl md:text-2xl text-gray-900 leading-snug" style={{ fontFamily: "'DM Serif Display',serif" }}>
          ...
          <Reveal delay={0.1}>
            <div className="relative pl-7 md:pl-9" style={{ borderLeft: "4px solid #1e3a8a" }}>
              <div className="flex items-center gap-2.5 mb-3">
                <Target className="w-5 h-5" style={{ color: "#1e3a8a" }} />
                <span className="text-xs font-bold tracking-widest uppercase" style={{ color: "#1e3a8a" }}>Our Mission</span>
              </div>
              <p className="text-xl md:text-2xl text-gray-900 leading-snug" style={{ fontFamily: "'DM Serif Display',serif" }}>
...
function Clients() {
  ...
  return (
    <section id="clients" className="py-12 md:py-24" style={{ background: "#f4f6f9" }}>
      <div className="max-w-7xl mx-auto px-6">
        <Reveal>
          <div className="text-center mb-8 md:mb-14">
            <span className="inline-block bg-blue-50 text-blue-700 text-xs font-semibold tracking-widest uppercase px-3 py-1.5 rounded-full mb-4">
            ...
            <h2 className="text-4xl md:text-5xl text-gray-900 mb-4">
              Our <span style={{ color: "#1e40af" }}>Clients</span> &amp; Industries
            </h2>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 md:gap-5 mb-16">
          {industries.map((item, i) => (
            <Reveal key={i} delay={i * 0.04}>
              <div className="relative rounded-2xl bg-white transition-all duration-300 group cursor-pointer p-5 md:p-7 flex flex-col items-center text-center"
                style={{ boxShadow: "0 4px 20px -4px rgba(15,23,42,0.10)" }}
                onMouseEnter={e => e.currentTarget.style.boxShadow = "0 14px 32px -8px rgba(15,23,42,0.22)"}
                onMouseLeave={e => e.currentTarget.style.boxShadow = "0 4px 20px -4px rgba(15,23,42,0.10)"}>
                <div className="w-16 h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center mb-4 transition-transform duration-300 group-hover:scale-110" style={{background: "#0f172a"}}>
                  <item.icon className="w-7 h-7 md:w-8 md:h-8" style={{color: "#3b82f6"}} />
                </div>
                <h4 className="font-bold text-gray-900 mb-1 text-xs md:text-sm leading-snug uppercase tracking-wide">{item.title}</h4>
                <p className="text-gray-500 text-[11px] md:text-xs leading-relaxed">{item.desc}</p>
              </div>
            </Reveal>
          ))}
        </div>
        <Reveal delay={0.1}>
          <div className="mb-10">
            <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-6 text-center" style={{ fontFamily: "'DM Serif Display',serif" }}>We Serve All Client Types</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5">
              {clientList.map((c, i) => (
                <div key={i} className="flex items-center gap-2.5 text-xs md:text-sm text-gray-700 bg-white hover:bg-blue-50 border border-gray-200 hover:border-blue-200 rounded-xl px-3.5 py-2.5 transition-colors" style={{ boxShadow: "0 2px 8px -2px rgba(15,23,42,0.06)" }}>
                  <CheckCircle className="w-4 h-4 shrink-0" style={{color: "#2563eb"}} fill="#dbeafe" strokeWidth={2.2} />
...
/* ── CONTACT ── */
function Contact() {
  const [form, setForm] = useState({ name: "", businessName: "", propertyType: "", location: "", email: "", phone: "", service: "", message: "" });
  ...
  const handleSubmit = async (e) => {
    ...
    setForm({ name: "", businessName: "", propertyType: "", location: "", email: "", phone: "", service: "", message: "" });
  };
  return (
    <section id="contact" className="overflow-hidden" style={{ background: "linear-gradient(180deg, #050b17 0%, #0a1730 40%, #102a4d 70%, #0a1730 100%)" }}>
      <div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-5 gap-8 items-start">
            <Reveal className="lg:col-span-3">
              <div className="relative rounded-3xl p-8 md:p-10" style={{ background: "#ffffff", boxShadow: "0 25px 60px -15px rgba(0,0,0,0.5)", border: "1px solid #ffffff" }}>
                ...
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0" style={{ background: "linear-gradient(135deg,#2563eb,#1e40af)" }}>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    <label className="block text-xs font-bold mb-1.5 uppercase tracking-wider" style={{ color: "#1e3a8a" }}>Service Required</label>
                  ...
                  <div>
                    <label className="block text-xs font-bold mb-1.5 uppercase tracking-wider" style={{ color: "#1e3a8a" }}>Message</label>
                    <textarea rows={4} placeholder="Tell us about your security requirements..."
                      value={form.message} onChange={e => setForm({ ...form, message: e.target.value })}
                      className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 text-sm text-gray-900 placeholder-gray-400 bg-white resize-none transition-all focus:outline-none focus:ring-2 focus:ring-blue-500/25 focus:border-blue-500" />
                  </div>
                  <button type="submit"
            ...
            <Reveal delay={0.15} className="lg:col-span-2 space-y-4">
              ...
              <div className="rounded-3xl p-6 space-y-3" style={{ background: "linear-gradient(180deg, #050b17 0%, #0a1730 45%, #102a4d 100%)" }}>
                ...
                {[
                  ...
                  { icon: Mail, color: "#1e3a8a", bg: "#eff6ff", label: "Email Us", lines: [{text: "info@enamos.co.ke", href: "mailto:info@enamos.co.ke"}] },
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          <div className="lg:col-span-2 pl-4 border-l-2" style={{ borderColor: "rgba(56,189,248,0.25)" }}>
            ...
            <div className="text-slate-500 text-xs space-y-1">
              ...
              <a href="mailto:info@enamos.co.ke" className="hover:text-sky-400 transition-colors">info@enamos.co.ke</a>
            </div>
          </div>
