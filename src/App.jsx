            ...
            <Reveal delay={0.15} className="lg:col-span-2 space-y-4">
              ...
              <div className="rounded-3xl p-5 bg-white border border-gray-100 shadow-sm">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a href="https://www.instagram.com/enamossecuritysolutions?igsh=MWgxdnBpMTFlNzllcg==" target="_blank" rel="noopener noreferrer"
                    className="w-10 h-10 rounded-full flex items-center justify-center transition-all hover:scale-110"
                  ...
                  <a href="https://wa.me/254722981621" target="_blank" rel="noopener noreferrer"
                    className="w-10 h-10 rounded-full flex items-center justify-center transition-all hover:scale-110"
